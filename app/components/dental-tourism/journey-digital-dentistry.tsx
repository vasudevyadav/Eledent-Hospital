    ...
    return (
        <section className="w-full lg:pt-6 pb-20">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-8 sm:mt-10 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-end mb-8">
                    ...
                    <div className="w-full">
                        <p className="text-sm sm:text-base  leading-relaxed text-primary mb-5">
