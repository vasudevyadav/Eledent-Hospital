...
export default function Navbar() {
  ...
  const isLocationsActive =
    ...
    locationsItems.some((item) => pathname === item.href);
                      ...
                      return (
                        <span key={item.key} className="flex items-center">
                          ...
                          >
                            ...
                            {servicesOpen && (
                              <div className="absolute left-0 top-6 z-50 mt-0 w-[38.5rem] rounded-lg border border-gray-100 bg-white px-4 py-3 shadow-xl">
      ...
      {pageLoading && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-white/70 backdrop-blur-sm">
          <div className="flex flex-col items-center gap-3">
            <div className="h-12 w-12 animate-spin rounded-full border-4 border-gray-300 border-t-[#E87733]"></div>
