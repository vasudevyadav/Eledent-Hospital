...
export default function AboutAppointment({
  ...
  return (
    <section className="w-full bg-white py-12 lg:py-10 lg:pt-32">
            ...
            <div className="flex min-h-[250px] items-center px-16 py-10">
              <div className="w-full lg:pl-[320px]">
                ...
                <button
                  type="button"
                  onClick={openModal}
                  className="mt-7 inline-flex items-center justify-center rounded-full bg-[#1F2937] px-8 py-2.5 text-sm font-semibold text-white shadow-[0_10px_24px_rgba(0,0,0,0.25)] transition hover:bg-[#111827]"
                >
                  Book Appointment
                </button>
              </div>
            ...
            <div className="relative overflow-hidden rounded-xl bg-white shadow-[0_18px_45px_rgba(0,0,0,0.18)]">
              ...
              <div className="relative p-7">
                ...
                <p className="mt-3 lg:text-sm text-xs leading-relaxed text-[#6B7280]">
                  If you are unsure about a dental concern, our team can guide you through the next step.
                </p>
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div className="min-w-0">
                      ...
                      <a
                        ...
                        className="text-sm lg:text-lg font-extrabold text-[#1F2937] hover:text-[#F47A20] mr-2"
                      >
                        9983868366
                      </a>
            ...
            <div className="overflow-hidden rounded-[22px] bg-[#F47A20] shadow-[0_18px_45px_rgba(0,0,0,0.10)]">
              <div className="px-6 lg:py-10 py-6">
                ...
                <button
                  type="button"
                  onClick={openModal}
                  className="mt-6 inline-flex items-center justify-center rounded-full bg-[#1F2937] px-7 py-2.5 text-[12px] font-semibold text-white shadow-[0_10px_24px_rgba(0,0,0,0.25)] transition hover:bg-[#111827]"
                >
                  Book Appointment
                </button>
              </div>
