...
export default function HomeFaq(): JSX.Element {
    ...
    const faqs: FaqItem[] = [
        ...
        },
        {
            ...
            answer:
                "Booking an appointment before visiting Eledent Dental Hospital is recommended because it helps reduce waiting time and connects you with the right specialist faster. Call +91 7799619994 or +91 7799769994 to book your appointment at any of the 5 Hyderabad branches most convenient for you.",
        },
        {
            id: 3,
