...
/**
 * Normalises any href coming from the API into a valid Next.js path.
 *
 * API sends values like:
 *   "/blogs/dental-implant-cost-in-hyderabad"  → kept as-is ✅
 *   "dental-implant-cost-in-hyderabad"          → "/blogs/dental-implant-cost-in-hyderabad"
 *   "/blog/dental-implant-…"                    → "/blogs/dental-implant-…"  (fixes singular)
 *   "https://backend.example.com/blogs/…"       → "/blogs/…"
 */
            ...
            {cards.map((c, idx) => (
              ...
              >
                ...
                <div className="px-6 pb-5 pt-5">
                  ...
                  <p className="mt-2 line-clamp-1 text-sm leading-relaxed text-black">
                    {c.desc}
                  </p>
                    ...
                    <div className="flex items-center gap-4 text-[#f47200]">
                      ...
                      >
                        <svg viewBox="0 0 24 24" className="h-4 w-4" fill="none" aria-hidden="true">
                          ...
                          <path d="M8.5 8.5 12 5l3.5 3.5" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round" />
