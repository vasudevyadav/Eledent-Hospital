...
export const metadataMap: Record<string, MetaEntry> = {
  ...
  "/our-team": {
    title: "Our Team - Eledent Dental Hospitals",
    description:
      "Meet the expert dentists and specialists at Eledent Dental Hospitals dedicated to advanced, safe, and patient-focused dental care in Hyderabad.",
  },
  "/award-recognition": {
    title: "Award & Recognition - Eledent Dental Hospitals",
    description:
      "Discover the awards and recognitions earned by Eledent Dental Hospitals for excellence in modern dental care and patient service.",
  },
  "/faq": {
    title: "FAQ - Eledent Dental Hospitals",
    description:
      "Find answers to common questions about treatments, appointments, consultations, branches, and dental care at Eledent Dental Hospitals.",
  },
  "/media": {
    title: "Media - Eledent Dental Hospitals",
    description:
      "Explore media coverage, updates, and highlights from Eledent Dental Hospitals and its advanced dental care services.",
  },
  "/testimonials": {
    title: "Testimonials - Eledent Dental Hospitals",
    description:
      "Read patient testimonials and experiences about dental treatments, expert care, and smile transformations at Eledent Dental Hospitals.",
  },
  "/thankyou": {
  ...
  "/services/invisalign-treatment-hyderabad": {
  ...
  "/services/laser-gum-treatment-hyderabad": {
  ...
  "/services/smile-makeover-in-hyderabad": {
  ...
  "/services/wisdom-teeth-removal-hyderabad": {
  ...
  "/services/dental-veneers-in-hyderabad": {
  ...
  "/services/orthodontist-in-hyderabad": {
  ...
  "/services/tooth-pain-treatment-in-hyderabad": {
  ...
  "/best-dental-hospital-in-hyderabad": {
    ...
    description:
      "Choose Eledent Hospitals for advanced dental care in Hyderabad with expert dentists, modern treatments, and patient-focused care.",
  },
  ...
  "/services/advanced-dental-implants": {
